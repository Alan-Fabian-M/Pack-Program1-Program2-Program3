...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Menus, Vcl.Grids, Cvector, UCVectorString;
...
var
 ...
 e : String ;
begin
   vs.Redimensionar(StrToInt(TxtDimen.Text));
  for i := 1 to vs.Dim do
   begin

     e:= SGvector.Cells[ i-1,0];
     vs.Modelemnt(i,e);
...
var
 ...
 e : String ;
begin
   SGvector.ColCount:= vs.Dim;
  for i := 1 to vs.dim  do
    begin
     e := vs.getElement(i);
     SGvector.Cells[i-1,0]:= e;
    end;
