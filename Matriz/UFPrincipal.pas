...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure insertargila1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.insertargila1Click(Sender: TObject);
begin
  m.InsFila(StrToInt(Txtfila.Text));
end;
